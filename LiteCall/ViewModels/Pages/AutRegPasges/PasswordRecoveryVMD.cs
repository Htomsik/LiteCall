...
internal class PasswordRecoveryVmd : BaseVmd
{
    ...
    public PasswordRecoveryVmd(INavigationService authPageNavigationServices, IStatusServices statusServices,
    ...
    private async Task OnRecoveryPasswordCommandExecuted(object p)
    {
        ...
        if (await _recoveryPasswordServices.RecoveryPassword(recoveryModel)) OpenAuthPageCommand.Execute(null);
    }
